...
contract ForTheRecord {
    ...
    event RecordSaved(address indexed fromAddress, uint indexed recordIndex, uint blockNumber, string message);
    ...
    function submitRecord(string memory message) public {
        ...
        emit RecordSaved(msg.sender, numberOfRecords, blockNumber, message);
        numberOfRecords++;
    }
}